#!/bin/bash
# wget https://raw.githubusercontent.com/SergeyMi37/vps_install/master/ubuntu/vps_ubuntu_install_both.sh && sudo chmod +x vps_ubuntu_install_both.sh && sudo ./vps_ubuntu_install_both.sh
...
# Запустите с доменами для каждого сервера
# sudo ./install_both.sh -d cross.example.com -r rust.example.com -e admin@example.com
set -e
